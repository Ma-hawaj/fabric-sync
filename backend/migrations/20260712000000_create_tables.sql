...
CREATE TABLE orders (
    ...
    -- A garment handed to a tailor needs a number the tailor can quote back,
    -- just like the tax invoice it rides on. The uuidv7 primary key is not
    -- quotable, so the human-readable identity lives here instead.
