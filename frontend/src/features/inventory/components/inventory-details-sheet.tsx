...
export function InventoryDetailsSheet({
  ...
  return (
    ...
    >
      <SheetContent className="data-[side=right]:w-full data-[side=right]:sm:w-3/4 data-[side=right]:sm:max-w-[48vw] overflow-y-auto bg-background/95 backdrop-blur-md border-s shadow-2xl">
        {material && (
