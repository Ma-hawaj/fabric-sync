    ...
    return (
      ...
      >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          <PopoverTrigger render={<Button variant="ghost" className="rounded-none rounded-s-md border border-input border-e-0 font-normal dark:bg-input/30" />}>{columnMeta?.icon && (
        ...
        <Button
          ...
          variant="ghost"
          className="h-full rounded-none rounded-e-md border border-input border-s-0 px-1.5 font-normal dark:bg-input/30"
